<template>
  ...
  >
    ...
    <span
      v-html="$t('contactsComponent.clickInfo')"
      class="w-auto xsm:hidden lg:text-[14px] lg:w-[180px] lg:h-[56px] bg-green h-[69px] rounded-[10px] text-[16px] leading-[16px] absolute"
    >
    </span>
  </a>
</template>
