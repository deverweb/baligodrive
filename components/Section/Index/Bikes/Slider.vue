  ...
  <section class="catalog z-[1] relative md:pb-[50px] xsm:pb-[97px] sm:flex sm:flex-col pb-[9px] xsm:flex xsm:flex-col bg-dark-300 text-dark">
    <div class="container">
      <div class="catalog-wrapper mb-[24px] xsm:mb-0 xsm:relative">
        <h2 class="catalog-title section-title text-center mb-[30px] md:mb-[26px] xsm:mb-[31px]">Каталог<br />байков</h2>
        <p class="catalog-desc section-desc text-center xsm:max-w-[233px] xsm:mb-[3px] xsm:mx-auto">Выберите и забронируйте байк из каталога</p>
    ...
    <div class="catalog-bikes bikes lg:gap-[36px] lg:grid-cols-1" v-if="bikes">
      ...
      >
        <SwiperSlide class="max-w-[440px] xsm:max-w-[340px] xsm:w-[100%]" v-for="(bike, i) in bikes"><SectionIndexBikesSlide :bike="bike"></SectionIndexBikesSlide></SwiperSlide>
      </Swiper>
    </div>
  </section>
</template>
